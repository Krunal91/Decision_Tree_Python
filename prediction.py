...
def predict(record,summary_train_model,parent,childNode):
    nodeDetails = summary_train_model.loc[summary_train_model['NodeNum'] == childNode ,["NodeType","SplitColumn","SplitValue","Child0","Child1","Parent","ClassLable"]]

    if(nodeDetails.iloc[0,0] == 'LN'):
